...
document.getElementById('offers').innerHTML = compiledOfferTemplate(offerTemplateData);
...
document.getElementById('sidebar').innerHTML = compiledSidebarTemplate(offerTemplateData);